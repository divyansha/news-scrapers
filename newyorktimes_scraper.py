...
def scrape(link):
	...
	all_paragraphs = soup_entire_html.find_all('div', {'class': 'articleBody'}) #finds all div objects with class articleBody. It was observed that for NewYorkTimes, there is only one such div tag per page
